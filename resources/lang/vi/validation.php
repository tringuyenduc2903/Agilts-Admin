...
return [
    ...
    'present_with' => 'Trường :attribute phải hiện diện khi :values hiện diện.',
    'present_with_all' => 'Trường :attribute phải hiện diện khi :values hiện diện.',
    ...
    'attributes' => [
        ...
        'addresses.*.province' => 'tỉnh/thành phố',
        'addresses.*.district' => 'quận/huyện/thị xã',
        'addresses.*.ward' => 'xã/phường/thị trấn',
        'addresses.*.address_detail' => 'địa chỉ chi tiết',
        'address.country' => 'quốc gia',
        'address.province' => 'tỉnh/thành phố',
        'address.district' => 'quận/huyện/thị xã',
        'address.ward' => 'xã/phường/thị trấn',
        'address.address_detail' => 'địa chỉ chi tiết',

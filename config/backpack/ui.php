...
return [
    ...
    */
    ...
    'home_link' => env('BACKPACK_PREFIX', ''),

    // Menu logo. You can replace this with an <img> tag if you have a logo.
    'project_logo' => env('APP_LOGO', '<b>Back</b>pack'),
    ...
    'developer_name' => env('DEV_NAME', 'Cristian Tabacitu'),

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => env('DEV_LINK', 'http://tabacitu.ro'),

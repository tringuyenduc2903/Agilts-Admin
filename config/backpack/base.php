...
use App\Http\Middleware\ThemeSwitcherMiddleware;
...
use Backpack\LanguageSwitcher\Http\Middleware\LanguageSwitcherMiddleware;
...
return [
    ...
    */
    ...
    'route_prefix' => env('BACKPACK_PREFIX', 'admin'),
    ...
    */
    ...
    'password_recovery_throttle_notifications' => config('auth.passwords.users.throttle', 600) * 10, // time in seconds
    ...
    'password_recovery_token_expiration' => config('auth.passwords.users.expire', 60), // time in minutes
